    ...
    <div class="app-content">
      <section class="section">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">云服务器信息展示</li>
        </ol>
        ...
        <div class="row">
          <div class="col-12 col-sm-12">
            <div class="card">
              ...
              <div class="card-body">
                <iframe src="http://grafana.lpj.com:80/d-solo/GDxMM26ik/yun-zhu-ji-jian-kong-tu?orgId=1&from=<%=lastTime%>&to=<%=nowTime%>&var-Node=xdata-hadoop-relay&panelId=7" width="1169.2" height="500" frameborder="0"></iframe>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-12 col-sm-12">
            <div class="card">
              ...
              <div class="card-body">
                <iframe src="http://grafana.lpj.com:80/d-solo/GDxMM26ik/yun-zhu-ji-jian-kong-tu?orgId=1&from=<%=lastTime%>&to=<%=nowTime%>&var-Node=xdata-hadoop-relay&panelId=8" width="1169.2" height="500" frameborder="0"></iframe>
              </div>
            </div>
          </div>
        </div>
