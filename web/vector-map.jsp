...
<head>
  ...
  <%
    ...
    long lastTime = nowTime - 3600000 * 24;
    ...
    <div class="app-content">
      <section class="section">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Nginx访问地图</li>
        </ol>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card m-b-20">
                <h5 class="card-header">Nginx访问地图</h5>
                <div class="card-body">
                  <iframe src="http://grafana.lpj.com:80/d-solo/q1jJYPemz/elasticsearch-nginx-logs-copy?orgId=1&from=<%=lastTime%>&to=<%=nowTime%>&var-domain=&var-status=All&var-responsetime=2&var-inter=%24__auto_interval_inter&panelId=35" width="1169.2" height="400" frameborder="0"></iframe>
                </div>
              </div>
            </div><!-- end col -->
          </div>
